...
{
color:rgba(17,96,183,1) !important;
...
{
background: rgba(255,255,255,0.25) 25% ;background: -moz-linear-gradient(right,  rgb(255,255,255) 25%, rgba(255,255,255,0) 100%) ;background: -webkit-gradient(linear,right,left,color-stop(25%, rgb(255,255,255)),color-stop(100%, rgba(255,255,255,0))) ;background: -webkit-linear-gradient(right,  rgb(255,255,255) 25%, rgba(255,255,255,0) 100%) ;background: -ms-linear-gradient(right,  rgb(255,255,255) 25%, rgba(255,255,255,0) 100%) ;background: linear-gradient(right,  rgb(255,255,255) 25%, rgba(255,255,255,0) 100%) ;filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#FFFFFF', endColorstr='#FFFFFF', GradientType=1) ;
...
{
background: rgba(255,255,255,0.15) 15% ;background: -moz-linear-gradient(right,  rgb(255,255,255) 15%, rgba(255,255,255,0) 100%) ;background: -webkit-gradient(linear,right,left,color-stop(15%, rgb(255,255,255)),color-stop(100%, rgba(255,255,255,0))) ;background: -webkit-linear-gradient(right,  rgb(255,255,255) 15%, rgba(255,255,255,0) 100%) ;background: -ms-linear-gradient(right,  rgb(255,255,255) 15%, rgba(255,255,255,0) 100%) ;background: linear-gradient(right,  rgb(255,255,255) 15%, rgba(255,255,255,0) 100%) ;filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#FFFFFF', endColorstr='#FFFFFF', GradientType=1) ;
...
{
background: rgba(255,255,255,0.25) 25% ;background: -moz-linear-gradient(bottom,  rgb(255,255,255) 25%, rgba(255,255,255,0) 100%) ;background: -webkit-gradient(linear,bottom,left,color-stop(25%, rgb(255,255,255)),color-stop(100%, rgba(255,255,255,0))) ;background: -webkit-linear-gradient(bottom,  rgb(255,255,255) 25%, rgba(255,255,255,0) 100%) ;background: -ms-linear-gradient(bottom,  rgb(255,255,255) 25%, rgba(255,255,255,0) 100%) ;background: linear-gradient(bottom,  rgb(255,255,255) 25%, rgba(255,255,255,0) 100%) ;filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#FFFFFF', endColorstr='#FFFFFF', GradientType=1) ;
...
{
background: rgba(231,239,247,0.15) 0% !important;background: -moz-linear-gradient(right,  rgb(231,239,247) 0%, rgba(231,239,247,0) 0%) !important;background: -webkit-gradient(linear,right,left,color-stop(0%, rgb(231,239,247)),color-stop(0%, rgba(231,239,247,0))) !important;background: -webkit-linear-gradient(right,  rgb(231,239,247) 0%, rgba(231,239,247,0) 0%) !important;background: -ms-linear-gradient(right,  rgb(231,239,247) 0%, rgba(231,239,247,0) 0%) !important;background: linear-gradient(right,  rgb(231,239,247) 0%, rgba(231,239,247,0) 0%) !important;filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#E7EFF7', endColorstr='#E7EFF7', GradientType=1) !important;

}

.notesWall .post.readMode .attachAction:hover .ms-crm-Inline-GradientMask
{
background: rgba(231,239,247,0.25) 0% !important;background: -moz-linear-gradient(right,  rgb(231,239,247) 0%, rgba(231,239,247,0) 0%) !important;background: -webkit-gradient(linear,right,left,color-stop(0%, rgb(231,239,247)),color-stop(0%, rgba(231,239,247,0))) !important;background: -webkit-linear-gradient(right,  rgb(231,239,247) 0%, rgba(231,239,247,0) 0%) !important;background: -ms-linear-gradient(right,  rgb(231,239,247) 0%, rgba(231,239,247,0) 0%) !important;background: linear-gradient(right,  rgb(231,239,247) 0%, rgba(231,239,247,0) 0%) !important;filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#E7EFF7', endColorstr='#E7EFF7', GradientType=1) !important;
...
{
background: rgba(231,239,247,0.25) 25% ;background: -moz-linear-gradient(right,  rgb(231,239,247) 25%, rgba(231,239,247,0) 100%) ;background: -webkit-gradient(linear,right,left,color-stop(25%, rgb(231,239,247)),color-stop(100%, rgba(231,239,247,0))) ;background: -webkit-linear-gradient(right,  rgb(231,239,247) 25%, rgba(231,239,247,0) 100%) ;background: -ms-linear-gradient(right,  rgb(231,239,247) 25%, rgba(231,239,247,0) 100%) ;background: linear-gradient(right,  rgb(231,239,247) 25%, rgba(231,239,247,0) 100%) ;filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#E7EFF7', endColorstr='#E7EFF7', GradientType=1) ;

}

TR.ms-crm-List-SelectedRow-Lite .ms-crm-Inline-Value div.ms-crm-Inline-GradientMask
{
background: rgba(248,250,252,0.25) 25% ;background: -moz-linear-gradient(right,  rgb(248,250,252) 25%, rgba(248,250,252,0) 100%) ;background: -webkit-gradient(linear,right,left,color-stop(25%, rgb(248,250,252)),color-stop(100%, rgba(248,250,252,0))) ;background: -webkit-linear-gradient(right,  rgb(248,250,252) 25%, rgba(248,250,252,0) 100%) ;background: -ms-linear-gradient(right,  rgb(248,250,252) 25%, rgba(248,250,252,0) 100%) ;background: linear-gradient(right,  rgb(248,250,252) 25%, rgba(248,250,252,0) 100%) ;filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#F8FAFC', endColorstr='#F8FAFC', GradientType=1) ;
...
{
border-top-color:rgba(17,96,183,1) !important;
...
.border-callout
{
border-color:rgba(17,96,183,1) !important;

}

.border-callout .border-notch
{
border-bottom-color:rgba(17,96,183,1) !important;
...
border-color:rgba(189,195,199,1) !important;
...
{
background: rgba(224,224,224,0.25) 25% !important;background: -moz-linear-gradient(bottom,  rgb(224,224,224) 25%, rgba(224,224,224,0) 100%) !important;background: -webkit-gradient(linear,bottom,left,color-stop(25%, rgb(224,224,224)),color-stop(100%, rgba(224,224,224,0))) !important;background: -webkit-linear-gradient(bottom,  rgb(224,224,224) 25%, rgba(224,224,224,0) 100%) !important;background: -ms-linear-gradient(bottom,  rgb(224,224,224) 25%, rgba(224,224,224,0) 100%) !important;background: linear-gradient(bottom,  rgb(224,224,224) 25%, rgba(224,224,224,0) 100%) !important;filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#E0E0E0', endColorstr='#E0E0E0', GradientType=1) !important;
